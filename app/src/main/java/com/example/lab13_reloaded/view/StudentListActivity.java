...
public class StudentListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview = (SwipeMenuListView) findViewById(R.id.student_list);
        ...
        studentList = estudianteDAO.selectAll();

        adapter = new ArrayAdapter<Estudiante>(this, android.R.layout.simple_list_item_1, studentList);
        ...
        listview.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                ...
                String nombre = studentList.get(position).getNombre();
                String apellidos = studentList.get(position).getApellidos();
                int edad = studentList.get(position).getEdad();
